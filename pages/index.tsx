    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.horizontalGrid}>
          <TiltCard image={"/P-Logo.webp"} alt={"Jack Foot Logo"} w={TCS} h={TCS} />
          <TiltCard image={"/typescript.webp"} alt={"Typescript Logo"} w={TCS} h={TCS} />
          <TiltCard image={"/nodedotjs.webp"} alt={"Node.js Logo"} w={TCS} h={TCS} />
          <TiltCard image={"/github.webp"} alt={"Github Logo"} w={TCS} h={TCS} />
          <TiltCard image={"/csharp.webp"} alt={"C# Logo"} w={TCS} h={TCS} />
        </div>
